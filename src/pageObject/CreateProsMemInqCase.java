...
public class CreateProsMemInqCase {
		...
		private By maximumRefChqBox = By.id("00NL0000003knkX");
		private By firstNameTxtbox = By.id("00NL0000003knkY");
		private By lastNameTxtbox = By.id("00NL0000003knkf");
		private By dobTxtbox = By.id("00NL0000003knkd");
		private By contactNameMemTxtbox = By.id("00NL0000003knkb");
		private By contactPhoneTxtbox = By.id("00NL0000003knkW");
		private By priLanListbox = By.id("00NL0000003knkg");
		private By relationToMemListbox = By.id("cas8");
		private By addLineTxtbox = By.id("00NL0000003knkY");
		private By addLine1Txtbox = By.id("00NL0000003knkZ");
		private By cityTxtbox = By.id("00NL0000003knka");
		private By stateListbox = By.id("00NL0000003knkh");
		private By zipTxtbox = By.id("00NL0000003kpaK");
		private By phoneTxtbox = By.id("00NF000000ColWq");
		private By regionListbox = By.id("00NF000000D2YGI");
		
		private By hearAbtListbox = By.id("");
		private By hearAbtSubListbox = By.id("");
		...
		private By prosMemInqAssCaseDate = By.id("00NL0000003kuvv");
		
		
		
		
		//This is Constructor
		public CreateProsMemInqCase(WebDriver driver) {
			this.driver = driver;
		}
		...
		// For Insert Text on Subject
			...
			// For Insert Text on Internal Comments
					...
					public void checkOnAssignRuls() {
						driver.findElement(maximumRefChqBox).click();
					}
